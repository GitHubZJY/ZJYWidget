...
import com.zjywidget.widget.camerapreview.base.DisplayOrientationDetector;
import com.zjywidget.widget.camerapreview.base.PreviewImpl;
import com.zjywidget.widget.camerapreview.impl.Camera1;
import com.zjywidget.widget.camerapreview.impl.Camera2;
import com.zjywidget.widget.camerapreview.impl.Camera2Api23;
import com.zjywidget.widget.camerapreview.impl.TextureViewPreview;
...
public class CameraView extends FrameLayout {
     ...
     */
    public static final int FLASH_TORCH = CameraConstants.FLASH_TORCH;
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setFlash(a.getInt(R.styleable.CameraView_flash, CameraConstants.FLASH_OFF));
        a.recycle();
    ...
    private PreviewImpl createPreviewImpl(Context context) {
        ...
        preview.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.CENTER));
        return preview;
    }
     ...
     * {@link Callback#onPictureTaken(CameraView, Bitmap)}.
     */
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void onPictureTaken(byte[] data) {
            TextureView textureView = (TextureView) getPreviewImpl().getView();
            if(textureView == null){
                return;
            }
            for (Callback callback : mCallbacks) {
                callback.onPictureTaken(CameraView.this, textureView.getBitmap(textureView.getWidth(),textureView.getHeight()));
            }
        }
